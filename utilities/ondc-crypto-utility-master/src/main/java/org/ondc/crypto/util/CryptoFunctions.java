...
/**
 * The Class CryptoFunctions provides generation of key pairs for signing and
 * encryption along with signing, verification, encryption and decryption.
 */
public class CryptoFunctions {
	...
	/**
	 * <p>
	 * This method generates ED25519 32 byte/256 bits key pair (Private and Public)
	 * for Signing
	 * </p>
	 * .
	 * 
	 * <pre style="background-color:black;color:white;font-family: Lucida Console,
	 ...
	 * 
	 * boolean verificationResult = CryptoFunctions.verify(signature, message.getBytes(),
	 * 		signingKeyPair.getPublickKey());
	 * </pre>
	 * 
	 * @author SujeetS
	...
	/**
	 * <p>
	 * This method generates signature using given ED25519 32 byte/ 256 bits Private
	 * key
	 * </p>
	 * .
	 * 
	 ...
	 * @return the byte[] signature of given message generated using given private
	 *         key
	...
	public static CryptoKeyPair generateEncDecKey() throws InvalidKeyException, NoSuchPaddingException,
		...
		CryptoKeyPair encryptionDecryptionKeyPair = new CryptoKeyPair(kp.getPublic().getEncoded(),
				kp.getPrivate().getEncoded());
		return encryptionDecryptionKeyPair;
	}

	/**
	 * This method can be used to do AES encryption and decryption using X25519 Key
	 * exchange algorithm
	 * 
	 * 
	 * <pre style="background-color:black;color:white;font-family: Lucida Console,
	 ...
	 * 
	 * byte[] encrypted = CryptoFunctions.encryptDecrypt(Cipher.ENCRYPT_MODE, message.getBytes(),
	 * 		senderEncDecKeyPair.getPrivateKey(), receiverEncDecKeyPair.getPublickKey());
	 * 
	 * System.out.println("\n\n/* Sender Side /");
	 * System.out.println("{");
	 ...
	 * 		+ Base64.getEncoder().encodeToString(senderEncDecKeyPair.getPrivateKey()) + "\",");
	 * System.out.println("\t\"receiverPublicKey \":\""
	 * 		+ Base64.getEncoder().encodeToString(receiverEncDecKeyPair.getPublickKey()) + "\"");
	 * System.out.println("}\n\n");
	 * byte[] decrypted = CryptoFunctions.encryptDecrypt(Cipher.DECRYPT_MODE, encrypted,
	 * 		receiverEncDecKeyPair.getPrivateKey(), senderEncDecKeyPair.getPublickKey());
	 * String decryptedMessage = new String(decrypted);
	 * System.out.println("\n\n/** Receiver Side ");
	 * System.out.println("{");
	 * System.out.println("\t\"DecryptedChallengeString \":\"" + decryptedMessage + "\",");
	 * System.out.println("\t\"receiverPrivateKey \":\""
	 * 		+ Base64.getEncoder().encodeToString(receiverEncDecKeyPair.getPrivateKey()) + "\",");
	 * System.out.println("\t\"senderPublicKey \":\""
	 * 		+ Base64.getEncoder().encodeToString(senderEncDecKeyPair.getPublickKey()) + "\"");
	 * System.out.println("}");
	 * </pre>
	 * 
	 * @author SujeetS
	 * @param mode             the mode to set either encrypt (<a href=
	 *                         "https://docs.oracle.com/en/java/javase/11/docs/api/constant-values.html#javax.crypto.Cipher.ENCRYPT_MODE">Cipher.ENCRYPT_MODE</a>)
	 *                         or decrypt (<a href=
	 *                         "https://docs.oracle.com/en/java/javase/11/docs/api/constant-values.html#javax.crypto.Cipher.DECRYPT_MODE">Cipher.DECRYPT_MODE
	 *                         </a>)
	 * @param challenge_string the challenge string that needs to be encrypted or
	 *                         decrypted depending on mode that is set. In case if
	 *                         mode is set to Cipher.ENCRYPT_MODE then this text
	 *                         shall be encrypted; whereas if mode is set to
	 *                         Cipher.DECRYPT_MODE, this text shall be decrypted
	 * @param privateKey       the private key.
	 *                         <p>
	 *                         In case of mode=Cipher.ENCRYPT_MODE, it should be
	 *                         private key of the sender
	 *                         <br>
	 *                         In case of mode=Cipher.DECRYPT_MODE, it should be
	 ...
	 * 
	 */
	public static byte[] encryptDecrypt(int mode, byte[] challenge_string, byte[] privateKey, byte[] publicKey)
